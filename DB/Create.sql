...
/****** Object:  Database [db]    Script Date: 06.04.2021 13:19:21 ******/
CREATE DATABASE [db]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'orders', FILENAME = N'C:\Users\maxPC\orders.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'orders_log', FILENAME = N'C:\Users\maxPC\orders_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
